  ...
  return (
    <div className="min-h-screen bg-[#030303] flex items-center justify-center px-4 pt-16">
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/4 right-1/4 w-64 h-64 bg-emerald-600/15 rounded-full blur-3xl" />
      ...
      >
        <div className="text-center mb-8">
          ...
          >
            Create your account to unlock advanced fact-checking capabilities
          </motion.p>
        </div>
        ...
        >
          ...
          <div className="mt-6 text-center text-sm text-gray-500">
            ...
            <Link to="/login" className="text-orange-400 hover:text-orange-300 transition-colors font-semibold tracking-wide">
              Sign in
            </Link>
          </div>
        </motion.div>
        ...
        >
          Guest users can analyze without registering — results won't be saved.
        </motion.p>
      </motion.div>
    </div>
  );
