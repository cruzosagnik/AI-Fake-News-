...
export const LogoLoop = memo(
  ({
    ...
    const measurementDependencies = useMemo(
      () => [logos, gap, logoHeight, isVertical],
      [logos, gap, logoHeight, isVertical],
    );

    useResizeObserver(updateDimensions, resizeElements, measurementDependencies);
    useImageLoader(seqRef, updateDimensions, measurementDependencies);
